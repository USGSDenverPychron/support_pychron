...
# Generation Time: 2015-05-24 15:28:05 +0000
# ************************************************************
...
CREATE TABLE `meas_AnalysisTable` (
  ...
  `data_reduction_tag_id` int(11) DEFAULT NULL,
  `gain_history_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `lab_id` (`lab_id`),
  ...
  KEY `user_id` (`user_id`),
  KEY `tag` (`tag`),
  KEY `data_reduction_tag_id` (`data_reduction_tag_id`),
  KEY `gain_history_id` (`gain_history_id`),
  ...
  CONSTRAINT `meas_analysistable_ibfk_8` FOREIGN KEY (`data_reduction_tag_id`) REFERENCES `proc_DataReductionTagTable` (`id`),
  CONSTRAINT `meas_analysistable_ibfk_9` FOREIGN KEY (`gain_history_id`) REFERENCES `meas_GainHistoryTable` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
# Dump of table meas_GainHistoryTable
# ------------------------------------------------------------

CREATE TABLE `meas_GainHistoryTable` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `meas_gainhistorytable_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `gen_UserTable` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;



# Dump of table meas_GainTable
# ------------------------------------------------------------

CREATE TABLE `meas_GainTable` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `meas_gaintable_ibfk_1` FOREIGN KEY (`history_id`) REFERENCES `meas_GainHistoryTable` (`id`),
  CONSTRAINT `meas_gaintable_ibfk_2` FOREIGN KEY (`detector_id`) REFERENCES `gen_DetectorTable` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
# Dump of table med_SampleImageTable
# ------------------------------------------------------------

CREATE TABLE `med_SampleImageTable` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(80) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `sample_id` (`sample_id`),
  CONSTRAINT `med_sampleimagetable_ibfk_1` FOREIGN KEY (`sample_id`) REFERENCES `gen_SampleTable` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
# Dump of table proc_ActionTable
# ------------------------------------------------------------

CREATE TABLE `proc_ActionTable` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `create_date` datetime DEFAULT NULL,
  `action` blob,
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `proc_actiontable_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `gen_UserTable` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `proc_BackgroundsSetTable` (
  ...
  `set_id` varchar(40) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `proc_BlanksHistoryTable` (
  ...
  CONSTRAINT `proc_blankshistorytable_ibfk_2` FOREIGN KEY (`action_id`) REFERENCES `proc_ActionTable` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
# Dump of table proc_BlanksSetValueTable
# ------------------------------------------------------------

CREATE TABLE `proc_BlanksSetValueTable` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `value` double DEFAULT NULL,
  ...
  KEY `analysis_id` (`analysis_id`),
  KEY `blanks_id` (`blanks_id`),
  CONSTRAINT `proc_blankssetvaluetable_ibfk_1` FOREIGN KEY (`analysis_id`) REFERENCES `meas_AnalysisTable` (`id`),
  CONSTRAINT `proc_blankssetvaluetable_ibfk_2` FOREIGN KEY (`blanks_id`) REFERENCES `proc_BlanksTable` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
# Dump of table proc_DataReductionTagSetTable
# ------------------------------------------------------------

CREATE TABLE `proc_DataReductionTagSetTable` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tag_id` int(11) DEFAULT NULL,
  `analysis_id` int(11) DEFAULT NULL,
  `selected_histories_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `tag_id` (`tag_id`),
  KEY `analysis_id` (`analysis_id`),
  KEY `selected_histories_id` (`selected_histories_id`),
  CONSTRAINT `proc_datareductiontagsettable_ibfk_1` FOREIGN KEY (`tag_id`) REFERENCES `proc_DataReductionTagTable` (`id`),
  CONSTRAINT `proc_datareductiontagsettable_ibfk_2` FOREIGN KEY (`analysis_id`) REFERENCES `meas_AnalysisTable` (`id`),
  CONSTRAINT `proc_datareductiontagsettable_ibfk_3` FOREIGN KEY (`selected_histories_id`) REFERENCES `proc_SelectedHistoriesTable` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;



# Dump of table proc_DataReductionTagTable
# ------------------------------------------------------------

CREATE TABLE `proc_DataReductionTagTable` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `proc_datareductiontagtable_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `gen_UserTable` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `proc_FitHistoryTable` (
  ...
  CONSTRAINT `proc_fithistorytable_ibfk_2` FOREIGN KEY (`action_id`) REFERENCES `proc_ActionTable` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
